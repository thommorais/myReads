...
export default class Search extends Component {
    ...
    render() {
        ...
        const {searchQry, results} = this.state;
            ...
            <div className="search-books">
                <div className="search-books-bar">
                    ...
                    <div className="search-books-input-wrapper">
                        ...
                        <input type="text" placeholder="Search by title or author" value={searchQry}
                ...
                <div className="search-books-results">
                    <ol className="books-grid">
                        {!hasResults && <div>Use your feelings, Obi-Wan, and find him you will.</div>}
                        {hasResults && results.map(book => <Book data={book} key={book.id} onChangeShelf={this.onChangeShelfInSearch.bind(this)} />)}
                    </ol>
                </div>
            </div>
